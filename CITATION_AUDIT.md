...
| Item used in the merged manuscript | Printed page | PDF page | Verified location and use |
|---|---:|---:|---|
...
- Preserved the irreducibility hypothesis when applying the unlimited theorem;
  the merged paper proves the needed within-orientation communication first.
